...
def handlerequest(request):
    # paytm will send you post request here with post request
    # kyoki post request aapki site se nhi paytm yahi cross origini se aa rahi h isliye csrf_exempt krna padega
    form = request.POST
    response_dict = {}
    for i in form.keys():
    ...
    if verify:
        if response_dict['RESPCODE'] == '01':
            ...
            print('order was no successful because' + response_dict['RESPMSG'])
